...
class PeepSoWidgetUserBar extends WP_Widget
{
    ...
    public function form( $instance ) {
        ...
        <b><?php echo __('Compact mode', 'peepso-core');?> <abbr title='When enabled, the Userbar is hidden under a profile icon toggle. This setting has no effect when previewing the widget in a block editor.'><i class="gcis gci-question-circle"></i></abbr></b>
        <p>
