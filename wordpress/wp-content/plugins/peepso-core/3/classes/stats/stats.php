...
<br/><br/>This data will help us focus our efforts better based on real world scenarios.';
			...
			if(isset($_GET['peepso_stats_details'])) {
				...
				<ul>
					...
					$desc = array(
                        ...
                        'videos_enable_aws_s3_elastic_transcoder' => 'Videos: is <b>Elastic Transcoder integration</b> enabled?',
					);
	...
	private function get_stats($desc=FALSE) {
		...
		$peepso_config = array(
            ...
            'videos_enable_aws_s3_elastic_transcoder' => (int) PeepSo::get_option('videos_enable_aws_s3_elastic_transcoder'),
		);
		...
		$stats = array(
            ...
            'prd_mobiloud'        => (int) class_exists('PeepSoMobiloudPlugin'),
            'prd_mobiloud_desc'    => 'MobiLoud Integration Plugin',

			'prd_pmp'           => (int) class_exists('PeepSoPMP'),
			'prd_pmp_desc'    => 'PMP Integration Plugin',

			'prd_social_login' => (int) (class_exists('TwistPress_Social_Login') ||class_exists('PeepSo_Social_Login') || class_exists('Social_Login')),
            ...
            'prd_wpem_desc'    => 'WP Event Integration Plugin',
